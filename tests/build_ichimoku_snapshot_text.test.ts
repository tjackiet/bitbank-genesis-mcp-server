...
import { buildIchimokuSnapshotText, type BuildIchimokuSnapshotTextInput } from '../tools/analyze_ichimoku_snapshot.js';
...
function makeInput(overrides?: Partial<BuildIchimokuSnapshotTextInput>): BuildIchimokuSnapshotTextInput {
  return {
    ...
    cloudHistory: [{ barsAgo: 0, position: 'above_cloud' }, { barsAgo: 5, position: 'above_cloud' }],
