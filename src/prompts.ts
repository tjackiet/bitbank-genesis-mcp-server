...
- ローソク足パターン（2本足）: render_candle_pattern_diagram → HTMLに埋め込み → present_files で提示
  ※ base64 Data URI や Markdown 直接貼り付けは不可
...
投資判断はご自身の責任でお願いします。`
  ...
  {
    name: '🌅 おはようレポート（直近8時間）',
    description: '直近8時間の価格変動・急変イベント・サポレジ接触・板状況をファクトベースで報告',
    messages: [
      {
        role: 'assistant',
        content: [{
          type: 'text',
          text: `直近8時間で何が起きたかをファクトベースでまとめてください。

【コンセプト】
- 起きたときに「何が起きたか」を素早く把握するためのレポート
...
**8時間前**: XX,XXX,XXX円 → **現在**: XX,XXX,XXX円
**変動**: ±X.X%（[上昇 📈 / 下落 📉 / ほぼ横ばい ➡️]）

\`\`\`
高値 XX,XXX,XXX円 ┄┄ XX:XX頃
     ↑ +X.X%
📍 XX,XXX,XXX円 ┄┄ 現在価格
     ↓ -X.X%
安値 XX,XXX,XXX円 ┄┄ XX:XX頃
\`\`\`

## ⚡ 主なイベント

【スパイクがあった場合】
- XX:XX頃に[急騰 🚀 / 急落 💥]（±X.X%、約XX万円の動き）  
  └ 大口の[買い/売り]が集中した可能性
...
【analyze_support_resistance の結果を使用】

【タッチ/突破/接近があった場合】
\`\`\`
🔴 XX,XXX,XXX円 ┄┄ レジスタンス（[状況の説明]）
     ↑ +X.X%
📍 XX,XXX,XXX円 ┄┄ 現在価格
     ↓ -X.X%
🟢 XX,XXX,XXX円 ┄┄ サポート（[状況の説明]）
\`\`\`
...
**取得時刻**: 2026-01-09 08:30（JST）

## 📊 価格の動き

**8時間前**: 15,234,000円 → **現在**: 15,456,000円
**変動**: +1.5%（上昇 📈）

\`\`\`
高値 15,512,000円 ┄┄ 05:30頃
     ↑ +0.4%
📍 15,456,000円 ┄┄ 現在価格
     ↓ -1.8%
安値 15,178,000円 ┄┄ 01:15頃
\`\`\`

## ⚡ 主なイベント

- 01:15頃に急落 💥（-2.1%、約32万円の動き）  
  └ 大口の売りが集中した可能性
- 05:30頃に急騰 🚀（+2.2%、約33万円の動き）  
  └ 押し目買いが入った模様
...
📍 15,456,000円 ┄┄ 現在価格
     ↓ -1.5%
🟢 15,220,000円 ┄┄ サポート（01:15頃に接近）
\`\`\`

└ サポートライン付近で反発、上値は15,800,000円が意識されそう
...
深夜に一時下落も、サポート付近で反発して上昇基調に戻っています。
板も買い優勢で、短期的には底堅い印象です。
...
⚠️ **免責事項**: この分析は参考情報です。投資判断はご自身の責任でお願いします。`
    ...
    metadata: {
      ...
      category: PromptCategory.ANALYSIS,
      estimatedTime: '20秒',
      tags: ['intermediate', 'btc', 'overnight', 'summary', 'flow', 'support-resistance']
    }
  },
  {
    name: '🌅 おはようレポート（ビジュアル版）',
...
2. get_candles(pair="btc_jpy", type="1hour", limit=8) → 確定済み8本の1時間足
3. get_flow_metrics(pair="btc_jpy", limit=300, bucketMs=60000) → 急騰/急落スパイク、出来高、売買バランス
  ...
  <div class="max-w-3xl mx-auto space-y-6">
    ...
    <section class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div class="bg-[#16213e] rounded-lg p-4">
        <h3 class="font-bold mb-2">📈 出来高</h3>
        <!-- 内容 -->
      </div>
      <!-- 売買比率カード -->
      <div class="bg-[#16213e] rounded-lg p-4">
        <h3 class="font-bold mb-2">⚖️ 売買比率</h3>
        <!-- 内容 -->
      </div>
    </section>
