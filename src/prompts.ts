...
| ボタンラベル | sendPrompt テキスト |
|---|---|
| 市場全体の変動 ↗ | アルトコインも含めた市場全体の変動率を見せて |
| 注目コイン ↗ | 今注目されているコインを教えて |

### セクション 3: 資産推移グラフ
| ボタンラベル | sendPrompt テキスト |
|---|---|
| 月次パフォーマンス詳細 ↗ | 月初からの取引履歴を詳しく見せて |

### セクション 4: 月初比 / 年初比 資産増減カード
| ボタンラベル | sendPrompt テキスト |
|---|---|
...
| ボタンラベル | sendPrompt テキスト |
|---|---|
| BTC分析 ↗ | BTCの現在の市場状況を分析して |
| ETH分析 ↗ | ETHの現在の市場状況を分析して |
...
| マーケットシグナル ↗ | BTCのマーケットシグナル（総合スコア）を出して |
